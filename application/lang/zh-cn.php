...
return [
    ...
    'hello'  => '欢迎使用',
    'maccms_name'=>'千寻视频',
    'maccms_copyright'=>'© qxsp All Rights Reserved.',
...
https://www.baidu.com/123.jpg
    ...
    'admin/index/index/menu_max' =>'最多可打开100个标签页',
    ...
    'admin/index/quickmenu/tip' =>'格式要求：1.菜单名称,菜单链接地址；2.每个快捷菜单各占一行；<br>
        ...
        2，支持插件文件，例如： 插件文console.log(off)件菜单,/application/xxxx.html<br>
    ...
    'admin/index/welcome/filed_php_ver' =>'环境版本',
    'admin/index/welcome/filed_thinkphp_ver' =>'版本号',
